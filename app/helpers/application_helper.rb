...
module ApplicationHelper
    ...
    def link_to_add_fields(name, form, association)
        ...
        # Takes an object (@recipe) and creates a new instance of its associated model (:addresses)
        # To better understand, run the following in your terminal:
        # rails c --sandbox
        # @recipe = Recipe.new
        # new_object = @recipe.send(:doses).klass.new
        ...
        # fields_options = { child_index: id }
            ...
            # `recipe[addresses_attributes][child_index_value][_destroy]`
